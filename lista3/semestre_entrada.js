...
function semestres_entrada(Alunos){
    let sem1 = sem2 = sem3 = sem4 = sem5 = 0;

    Alunos.forEach(element => {
      if (element.matricula[3] == '9'){
        sem1++;
      } else if (element.matricula[3] == '1'){
        sem2++;
      } else if (element.matricula[3] == '2'){
          if (element.matricula[4] == '1'){
            sem3++;
          } else if (element.matricula[4] == '2'){
            sem4++;
          }
      } else if (element.matricula[3] == '3'){
        sem5++;
      }
    });

    return `semestre: '2019.1', quantidade: ${sem1},`
}