...
function estatistica_naturalidade(Alunos){
    let petrolina = beloj = olinda = paulista = recife = 0;

    Alunos.forEach(element => {
        if(element.naturalidade == "Petrolina - PE"){
            petrolina++;
        }else if(element.naturalidade == "Belo Jardim - PE"){
            beloj++;
        }else if(element.naturalidade == "Olinda - PE"){
            olinda++;
        }else if(element.naturalidade == "Paulista - PE"){
            paulista++;
        }else if(element.naturalidade == "Recife - PE"){
            recife++;
        }
    });

    return `Petrolina - PE:${petrolina},\n Belo Jardim - PE:${beloj},\n Olinda - PE:${olinda},\n Paulista - PE:${paulista},\n Recife - PE:${recife}}` ;
}
